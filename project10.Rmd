...
divide rainfall
```{r}
rainfall_group<- cut(survey_final_gis_clean$rainfall, c(0,1950,2300), label=c("low","high"))
survey_final_gis_clean2 <- mutate(survey_final_gis_clean, rainfall_group)
aov_incbeef2 <- aov(incbeef ~ rainfall_group, data=survey_final_gis_clean2)
