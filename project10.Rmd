...
```{r}
g <- ggplot(data = survey_final_gis_clean, aes(y = log(drainage_area_km), x = as.factor(region)))
g + geom_boxplot() + labs(title = "Boxplot of Drainage Area grouped by region") +
  xlab("region")
g <- ggplot(data = survey_final_gis_clean, aes(y = rainfall, x= as.factor(region)))
g + geom_boxplot() + labs(title = "Boxplot of rainfall grouped by region") +
  xlab("region")
g <- ggplot(data = survey_final_gis_clean, aes(y = vechval, x = as.factor(region)))
...
```{r}
g <- ggplot(data = survey_final_gis, aes(y = log(drainage_area_km), x = as.factor(cattle_management)))
g + geom_boxplot() + labs(title = "Boxplot of Drainage Area grouped by Cattle_management") +
  xlab("cattle_management")

g <- ggplot(data = survey_final_gis, aes(y = rainfall, x = as.factor(cattle_management)))
g + geom_boxplot() + labs(title = "Boxplot of rainfall grouped by Cattle_management") +
  xlab("cattle_management")

g <- ggplot(data = survey_final_gis, aes(y = vechval, x = as.factor(cattle_management)))
...
```{r}
g <- ggplot(data = survey_final_gis, aes(y = log(drainage_area_km), x = as.factor(pasture_management)))
g + geom_boxplot() + labs(title = "Boxplot of Drainage Area grouped by pasture_management") +
  xlab("pasture_management")

g <- ggplot(data = survey_final_gis, aes(y = rainfall, x = as.factor(pasture_management)))
g + geom_boxplot() + labs(title = "Boxplot of Vrainfall grouped by pasture_management") +
  xlab("pasture_management")

g <- ggplot(data = survey_final_gis, aes(y = vechval, x = as.factor(pasture_management)))
...
Boxplotx of milkincome, SPI and rainfall
```{r}
...
### Effect of region on drainage area, rainfall and vechval  
```{r}
g <- ggplot(data = survey_final_gis, aes(y = log(drainage_area_km), x = as.factor(region)))
g + geom_boxplot() + labs(title = "Boxplot of Drainage Area grouped by region") +
  xlab("region")
g <- ggplot(data = survey_final_gis, aes(y = rainfall, x= as.factor(region)))
g + geom_boxplot() + labs(title = "Boxplot of rainfall grouped by region") +
  xlab("region")
g <- ggplot(data = survey_final_gis, aes(y = vechval, x = as.factor(region)))
g + geom_boxplot() + labs(title = "Boxplot of Vehicle Value grouped by region") +
  xlab("region")
```
### Effect of cattle_management on drainage area, rainfall and vechval  
...
Let's make some plots to visualize them, starting with cattle management
```{r}
Predicted_data <- data.frame(drainage_area_km=seq(
  min(survey_final_gis$drainage_area_km), max(survey_final_gis_wealth$drainage_area_km),len=500))
...
fit_forest_full <- glm(forest_conservation ~ SPImin_year + vechval, family = binomial,data = survey_final_gis)
summary(fit_forest_full)
>>>>>>> 95a463982d9d5dc1c2587acd48b2396e2ac5190d
```