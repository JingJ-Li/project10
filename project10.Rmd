...
```{r}
g <- ggplot(data = survey_final_gis, aes(x = log(drainage_area_km), y = as.factor(any_adaptation)))
g + geom_boxplot() + labs(title = "Boxplot of Drainage Area grouped by Cattle_management") +
  ylab("any_adaptation")

g <- ggplot(data = survey_final_gis, aes(x = rainfall, y = as.factor(any_adaptation)))
